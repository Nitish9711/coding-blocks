...
public:
    ...
    // to make functions constant 
    // const function are those which don't update data members
	void print() const{
		cout<<"Name "<<name<<endl;
    ...
    // to make parameter constant 
    // constant parameters are those which don't get updated inside the function 
